...
public class GameOverPanel extends JLayeredPane{
	...
	GameOverPanel(JButton re, JButton cl){
		...
		this.add(trophy, Integer.valueOf(1));
		this.add(text, Integer.valueOf(1));
		this.add(waveNums[0], Integer.valueOf(1));
		this.add(waveNums[1], Integer.valueOf(1));
		this.add(tryAgain, Integer.valueOf(1));
		this.add(chooseLevel, Integer.valueOf(1));
	}
	...
	public void setVictory(boolean victory) {
		if(victory) {
			set(1, 0, 10); // Victory screen with maximum hearts
		} else {
			set(0, 0, 0); // Defeat screen
		}
	}
}